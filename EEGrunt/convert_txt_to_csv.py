...
input_headers = ['id','chan1','chan2','chan3','chan4','accel1','accel2','accel3'];
...
for input_fn in csv_files:
  ...
  with open(os.path.join(input_path,input_fn), 'rt') as csvfile:
  ...
  output_csv_file = open(os.path.join(output_path,output_fn), 'wt')
